#ifndef DS1302_CLASS_INCLUDED
#define DS1302_CLASS_INCLUDED
// DS1302 RTC
// ----------
//
...
#define DS1302_TRICKLE_EN        0xA0
#define DS1302_TRICKLE_1_DROP_DIODE  (1<<2)
#define DS1302_TRICKLE_2_DROP_DIODE  (1<<3)
#define DS1302_TRICKLE_2KOHM           0x01
#define DS1302_TRICKLE_4KOHM           0x02
#define DS1302_TRICKLE_8KOHM           0x03
...
protected:
	...
	public:
		DS1302(int _rst, int _sclk, int _io);
		void init();
		// --------------------------------------------------------
		// DS1302_write
		//
		...
		timedata readtime();
		void writetime(timedata&td);
		unsigned long int getTimestamp(timedata td);
		timedata fromTimestamp(unsigned long int ts);
		void writeRAMbyte(uint8_t address, uint8_t data);
		uint8_t readRAMbyte(uint8_t address);
		void setTrickleMode(uint8_t mode);
		uint8_t getTrickleMode();
};
#endif
